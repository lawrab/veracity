...
class TestTrendService:
    ...
    async def test_detect_trends_identifies_clusters(self, trend_service, sample_posts):
        ...
        with patch('app.services.trend_service.TrendService._extract_topics') as mock_extract:
            mock_extract.return_value = ["AI", "healthcare", "technology"]
            
            with patch('app.services.trend_service.TrendService._calculate_trend_score') as mock_score:
    ...
    async def test_identify_emerging_trends(self, trend_service, sample_posts):
        ...
        with patch('app.services.trend_service.TrendService._calculate_growth_rate') as mock_growth:
    ...
    async def test_correlate_with_news(self, trend_service):
        ...
        news_articles = [
            {"title": "AI transforms healthcare industry", "categories": ["technology", "health"]},
